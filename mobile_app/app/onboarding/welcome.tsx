...
const FEATURES = [
  ...
  },
  {
    ...
    sub: "Rain, AQI, and flood covered",
  },
  {
    icon: "cash-outline",
    color: Brand.success,
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
      ...
      <View style={styles.hero}>
        <GigzoLogoMark inverted size={60} style={styles.logo} />
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.sub}>
          Automatic income protection for gig delivery workers. Get paid when
          disruptions stop your work.
        </Text>
