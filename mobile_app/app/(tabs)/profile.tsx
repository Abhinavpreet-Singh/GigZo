...
const statusColor = (s: PayoutStatus) => {
  switch (s) {
    case 'PAID': return { text: Brand.primary, bg: Brand.primaryLight };
    case 'VERIFIED': return { text: Brand.primaryMid, bg: Brand.primaryLight };
    case 'PENDING': return { text: Brand.primaryDark, bg: Brand.accentLight };
    default: return { text: Neutral[500], bg: Neutral[100] };
  }
};

function HistoryItem({ item }: {
  item: { id: string; type: PayoutType; title: string; date: string; amount: number; status: PayoutStatus };
}) {
  ...
  return (
    <View style={styles.item}>
      ...
      <View style={styles.itemRight}>
        <Text style={[styles.itemAmt, { color: item.status === 'PAID' ? Brand.primary : Neutral[400] }]}>
...
const SETTINGS = [
  { icon: 'notifications-outline', label: 'Notifications', sub: 'Alert preferences' },
  { icon: 'shield-outline', label: 'Fraud Transparency', sub: 'How we verify claims' },
  { icon: 'help-circle-outline', label: 'Help & Support', sub: 'FAQs and contact' },
  { icon: 'document-text-outline', label: 'Policy Documents', sub: 'Terms and coverage details' },
] as const;
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <View style={styles.planStrip}>
          <View style={styles.planStripLeft}>
            ...
            <View>
              ...
              <Text style={styles.planStripSub}>₹{user.coveragePerDay}/day · {user.daysLeft} days remaining</Text>
            </View>
          </View>
        ...
        <View style={styles.statsRow}>
          {[
            { label: 'Total Received', value: `₹${mockHistoryStats.totalReceived.toLocaleString()}` },
        ...
        <View style={styles.streakCard}>
          <View style={[styles.streakIcon, { backgroundColor: Brand.primaryLight }]}>
            ...
            {SETTINGS.map((s, idx) => (
              <View key={s.label}>
                <TouchableOpacity style={styles.settingRow}>
                  <View style={[styles.settingIcon, { backgroundColor: Brand.primaryLight }]}>
                  ...
                  <Ionicons name="chevron-forward" size={15} color={Neutral[300]} />
                </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  driverCard: {
    ...
    backgroundColor: Neutral.white, margin: Spacing.lg, marginBottom: 0,
  ...
  avatarText: { fontFamily: Font.bold, fontSize: 22, color: Neutral.white, letterSpacing: 1 },
  protectedDot: {
  ...
  driverInfo: { flex: 1 },
  driverName: { fontFamily: Font.bold, fontSize: 18, color: Neutral[900], marginBottom: 6 },
  driverMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 5 },
  platformPill: {
    backgroundColor: Brand.primaryLight, paddingHorizontal: 10, paddingVertical: 3,
    borderRadius: Radius.full,
  },
  platformText: { fontFamily: Font.semiBold, fontSize: 11, color: Brand.primary },
  ...
  planStripLeft: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md },
  planStripTitle: { fontFamily: Font.semiBold, fontSize: 14, color: Neutral.white },
  planStripSub: { fontFamily: Font.regular, fontSize: 11, color: 'rgba(255,255,255,0.65)', marginTop: 2 },
  planStripBtn: {
    backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 14, paddingVertical: 7,
    borderRadius: Radius.full,
  },
  planStripBtnText: { fontFamily: Font.semiBold, fontSize: 13, color: Neutral.white },
  ...
  statCard: {
    flex: 1, backgroundColor: Neutral.white,
  ...
  sectionTitle: { fontFamily: Font.bold, fontSize: 16, color: Neutral[900], marginBottom: Spacing.md },
  filterRow: { gap: Spacing.sm, marginBottom: Spacing.md },
  filterTab: {
    paddingHorizontal: 16, paddingVertical: 7, borderRadius: Radius.full,
    borderWidth: 1.5, borderColor: Neutral[200], backgroundColor: Neutral.white,
  },
  ...
  list: {
    ...
    overflow: 'hidden', borderWidth: 1, borderColor: Neutral[100], ...Shadow.xs,
  },
  ...
  itemType: { fontFamily: Font.bold, fontSize: 9, color: Neutral[400], letterSpacing: 0.4 },
  ...
  settingLabel: { fontFamily: Font.semiBold, fontSize: 14, color: Neutral[800] },
  settingSub: { fontFamily: Font.regular, fontSize: 11, color: Neutral[400], marginTop: 2 },
  ...
  signOut: {
    ...
    borderWidth: 1.5, borderColor: Brand.dangerLight,
  },
